...
overlay_dir "$REPO_DIR/layouts/xedition"           "$WEB/layouts/xedition"
overlay_dir "$REPO_DIR/m.layouts/default"        "$WEB/m.layouts/default"
overlay_dir "$REPO_DIR/addons"                     "$WEB/addons"
overlay_dir "$REPO_DIR/board_skins"                "$WEB/board_skins"
